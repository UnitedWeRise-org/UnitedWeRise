...
exports.redactSensitiveQuery = redactSensitiveQuery;
exports.getSensitiveParams = getSensitiveParams;
/**
 ...
 */
function redactSensitiveParamsRegex(url) {
    let sanitized = url;
    SENSITIVE_PARAMS.forEach(param => {
 ...
 */
function getSensitiveParams() {
    return SENSITIVE_PARAMS;
}
//# sourceMappingURL=urlSanitizer.js.map