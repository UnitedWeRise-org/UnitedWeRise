...
class CivicOrganizingService {
     ...
     * PETITION MANAGEMENT
     */
    async createPetition(userId, data) {
    ...
    async getPetitions(filters = {}, page = 1, limit = 20) {
    ...
    async getPetitionById(id) {
        ...
        if (petition) {
            petition.progress = petition.signatureGoal > 0 ?
                Math.min(100, (petition.currentSignatures / petition.signatureGoal) * 100) : 0;
        }
        return petition;
    }
    ...
    async getEvents(filters = {}, page = 1, limit = 20) {
        ...
        if (filters.timeframe) {
            const now = new Date();
            let dateFilter = { gte: now }; // Future events by default
    ...
    async searchCivic(query, filters = {}, page = 1, limit = 20) {
...
exports.CivicOrganizingService = CivicOrganizingService;
exports.default = new CivicOrganizingService();
//# sourceMappingURL=civicOrganizingService.js.map