...
class OnboardingService {
    ...
    async getOnboardingSteps(userId) {
        ...
        const profile = (user === null || user === void 0 ? void 0 : user.onboardingData) || await this.createOnboardingProfile(userId);
        const steps = [
            {
                id: 'welcome',
            ...
            },
            {
                ...
                required: true,
                completed: (user === null || user === void 0 ? void 0 : user.emailVerified) && (user === null || user === void 0 ? void 0 : user.phoneVerified) || false,
                data: {
                    emailVerified: (user === null || user === void 0 ? void 0 : user.emailVerified) || false,
                    phoneVerified: (user === null || user === void 0 ? void 0 : user.phoneVerified) || false
                }
            },
            {
                id: 'location',
                ...
                required: true,
                completed: profile.completedSteps.includes('location') || !!(user === null || user === void 0 ? void 0 : user.zipCode),
            ...
            },
            {
                ...
                required: false,
                completed: profile.completedSteps.includes('profile') || (!!(user === null || user === void 0 ? void 0 : user.bio) && !!(user === null || user === void 0 ? void 0 : user.avatar)),
    ...
    async completeStep(userId, stepId, stepData) {
        ...
        let profile = (user === null || user === void 0 ? void 0 : user.onboardingData) || await this.createOnboardingProfile(userId);
        ...
        // Store step data
        if (stepData) {
            profile.profileData = Object.assign(Object.assign({}, profile.profileData), { [stepId]: stepData });
