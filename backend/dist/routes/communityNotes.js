...
router.post('/', auth_1.requireAuth, async (req, res) => {
    try {
        ...
        const note = await communityNotesService_1.CommunityNotesService.createNote({
            authorId,
            content,
            noteType,
            postId,
        ...
        logger_1.default.info('Community note created', { noteId: note.id, authorId });
        return res.status(201).json(note);
    }
    catch (error) {
        logger_1.default.error('Create community note failed', error);
...
router.get('/:id', async (req, res) => {
    try {
        const note = await communityNotesService_1.CommunityNotesService.getNote(req.params.id);
        if (!note) {
        ...
        logger_1.default.error('Get community note failed', error);
        return res.status(500).json({ error: 'Internal server error' });
    }
});
/**
...
router.get('/post/:postId', async (req, res) => {
    try {
        ...
        const notes = await communityNotesService_1.CommunityNotesService.getPostNotes(req.params.postId, includeHidden);
        return res.json(notes);
    }
    catch (error) {
        logger_1.default.error('Get post notes failed', error);
        return res.status(500).json({ error: 'Internal server error' });
    }
});
/**
...
router.get('/fact/:factClaimId', async (req, res) => {
    try {
        const notes = await communityNotesService_1.CommunityNotesService.getFactNotes(req.params.factClaimId);
        return res.json(notes);
    }
    catch (error) {
        logger_1.default.error('Get fact notes failed', error);
        return res.status(500).json({ error: 'Internal server error' });
    }
});
// ==========================================
 ...
 */
router.post('/:id/vote', auth_1.requireAuth, async (req, res) => {
    try {
        ...
        const result = await communityNotesService_1.CommunityNotesService.voteOnNote(noteId, voterId, isHelpful);
        logger_1.default.info('Community note vote recorded', { noteId, voterId, isHelpful, shouldDisplay: result.shouldDisplay });
        return res.json(result);
    }
    catch (error) {
        logger_1.default.error('Vote on note failed', error);
        return res.status(500).json({ error: 'Internal server error' });
    }
});
// ==========================================
 ...
 */
router.post('/:id/appeal', auth_1.requireAuth, async (req, res) => {
    try {
        ...
        const result = await communityNotesService_1.CommunityNotesService.appealNote(noteId, appealerId, reason);
        logger_1.default.info('Community note appealed', { noteId, appealerId });
        return res.json(result);
    }
    catch (error) {
        ...
        logger_1.default.error('Appeal note failed', error);
        return res.status(500).json({ error: 'Internal server error' });
    }
});
/**
 ...
 */
router.post('/:id/resolve-appeal', auth_1.requireAuth, auth_1.requireAdmin, async (req, res) => {
    try {
        ...
        const result = await communityNotesService_1.CommunityNotesService.resolveAppeal(noteId, adminId, upheld, reason);
        logger_1.default.info('Community note appeal resolved', { noteId, adminId, upheld });
        return res.json(result);
    }
    catch (error) {
        logger_1.default.error('Resolve appeal failed', error);
        return res.status(500).json({ error: 'Internal server error' });
    }
});
/**
 ...
 */
router.get('/admin/pending-appeals', auth_1.requireAuth, auth_1.requireAdmin, async (req, res) => {
    try {
        const appeals = await communityNotesService_1.CommunityNotesService.getPendingAppeals();
        return res.json(appeals);
    }
    catch (error) {
        logger_1.default.error('Get pending appeals failed', error);
        return res.status(500).json({ error: 'Internal server error' });
    }
});
// ==========================================
...
router.get('/user/notes', auth_1.requireAuth, async (req, res) => {
    try {
        ...
        logger_1.default.error('Get user notes failed', error);
        return res.status(500).json({ error: 'Internal server error' });
    }
});
/**
...
router.get('/user/votes', auth_1.requireAuth, async (req, res) => {
    try {
        ...
        logger_1.default.error('Get user votes failed', error);
        return res.status(500).json({ error: 'Internal server error' });
    }
});
