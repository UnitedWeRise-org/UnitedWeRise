...
router.post('/refresh', async (req, res) => {
    ...
    try {
        ...
        const refreshToken = isMobileClient
            ? (req.body?.refreshToken || req.cookies?.[cookies_1.COOKIE_NAMES.REFRESH_TOKEN])
            : req.cookies?.[cookies_1.COOKIE_NAMES.REFRESH_TOKEN];
        ...
        req.log.info({
            ...
            hasCookie: !!req.cookies?.[cookies_1.COOKIE_NAMES.REFRESH_TOKEN],
        ...
        if (!refreshToken) {
            req.log.warn({
                ...
                userAgent,
                allCookieNames,
                hasAuthToken: allCookieNames.includes(cookies_1.COOKIE_NAMES.AUTH_TOKEN),
                hasCsrfToken: allCookieNames.includes(cookies_1.COOKIE_NAMES.CSRF_TOKEN)
        ...
        const responseData = { success: true, csrfToken };
        if (isMobileClient) {
