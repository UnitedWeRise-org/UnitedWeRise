...
router.get('/user/:userId', async (req, res) => {
    try {
        ...
        const reputation = await reputationService_1.reputationService.getUserReputation(userId);
        res.json({
            userId,
            reputation
        });
...
router.get('/me', auth_1.requireAuth, async (req, res) => {
    try {
        ...
        logger_1.default.error('Failed to get current user reputation:', error);
        res.status(500).json({ error: 'Failed to get reputation' });
    }
});
...
router.get('/history', auth_1.requireAuth, async (req, res) => {
    try {
        ...
        logger_1.default.error('Failed to get reputation history:', error);
...
router.post('/analyze', auth_1.requireAuth, async (req, res) => {
    try {
        ...
        logger_1.default.error('Failed to analyze content:', error);
...
router.post('/report', auth_1.requireAuth, async (req, res) => {
    try {
        ...
        const result = await reputationService_1.reputationService.processReport(reporterId, targetUserId, postId, reason, post.content);
        if (result.accepted) {
            res.json({
...
router.post('/appeal', auth_1.requireAuth, async (req, res) => {
    try {
        ...
        const result = await reputationService_1.reputationService.processAppeal(userId, eventId, reason);
        res.json(result);
    }
    catch (error) {
...
router.post('/award', auth_1.requireAuth, auth_1.requireAdmin, async (req, res) => {
    try {
        ...
        const result = await reputationService_1.reputationService.awardReputation(userId, reason, postId);
        res.json({
        ...
        logger_1.default.error('Failed to award reputation:', error);
...
router.get('/stats', auth_1.requireAuth, auth_1.requireAdmin, async (req, res) => {
    try {
        ...
        logger_1.default.error('Failed to get reputation stats:', error);
...
router.get('/low-reputation', auth_1.requireAuth, auth_1.requireAdmin, async (req, res) => {
    try {
        ...
        logger_1.default.error('Failed to get low reputation users:', error);
