...
async function generateTestUsers() {
    ...
    const hashedPassword = await bcryptjs_1.default.hash('TestUser123!', 10);
    const users = [];
    const posts = [];
    ...
    for (let i = 0; i < 100; i++) {
        ...
        const user = {
            ...
            politicalProfileType: client_1.PoliticalProfileType.CITIZEN,
            emailVerified: true,
            verified: false,
