...
import petitionSigningRoutes from './routes/petitionSigning';
import verificationBillingRoutes from './routes/verificationBilling';
...
app.use('/api/petitions', petitionSigningRoutes);
app.use('/api/verification-billing', verificationBillingRoutes);
