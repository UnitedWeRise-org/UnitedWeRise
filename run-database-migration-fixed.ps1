...
try {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        if ($LASTEXITCODE -eq 0) {
            ...
            Write-Host ""
            Write-Host "Backend is now fully operational!" -ForegroundColor Green
            ...
            Write-Host "Health Check: https://unitedwerise-backend.wonderfulpond-f8a8271f.eastus.azurecontainerapps.io/health" -ForegroundColor White
