...
Write-Host "`nInfrastructure created successfully!" -ForegroundColor Green

# Get connection strings and important info
Write-Host "`nCollecting connection information..." -ForegroundColor Cyan
...
Write-Host "`nSAVE THIS PASSWORD: $DB_PASSWORD" -ForegroundColor Red

Write-Host "`nUseful URLs:" -ForegroundColor White
